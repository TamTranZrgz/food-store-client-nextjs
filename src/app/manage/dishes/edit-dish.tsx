...
export default function EditDish({
  ...
  // use custom hook for to get dish detail, and update dish
  ...
  useEffect(() => {
    if (data) {
      const { name, image, price, status, description } = data.payload.data;
      form.reset({
        name,
        image: image ?? undefined, // image is null, will take an empty string as value
        description,
        price,
        status,
      });
