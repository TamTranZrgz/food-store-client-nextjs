...
import { getEnglishDishStatus, handleErrorApi } from "@/lib/utils";
import {
  CreateDishBody,
  CreateDishBodyType,
...
export default function AddDish() {
  ...
  const onSubmit = async (values: CreateDishBodyType) => {
    ...
    try {
      ...
      reset();
      setOpen(false); // close dialog AFTER submit successfully
    } catch (error) {
      handleErrorApi({
        error,
